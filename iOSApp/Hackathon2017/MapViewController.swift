...
class MapViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let place1 = Place()
        place1.latitude = 52.3917953
        place1.longitude = 16.857482
        place1.name = "Pixel, Grunwaldzka 182, 60-166 Poznań, Polska"
        let place2 = Place()
        place2.latitude = 52.4537902
        place2.longitude = 16.9275968
        place2.name = "Umultowska 45, Poznań, Polska"
